...
//    added from the power Vm
    ...
    private double normWorkLoadRate;
    
    private double memoryUtiliztion;
	...
	public double getNormWorkLoadRate() {
		return normWorkLoadRate;
	}

	public void setNormWorkLoadRate(double normWorkLoadRate) {
		this.normWorkLoadRate = normWorkLoadRate;
	}

...
//                container.setVm(containerVm);
            ...
            Log.formatLine("Number of containers allocated using Threshold based resource allocation to VM1 = \n"+ vm1);
            Log.formatLine("Number of containers allocated using Threshold based resource allocation to VM2 = \n"+ vm2);
            Log.formatLine("Number of containers allocated using Threshold based resource allocation to VM3 = \n"+ vm3);
            return false;
        }

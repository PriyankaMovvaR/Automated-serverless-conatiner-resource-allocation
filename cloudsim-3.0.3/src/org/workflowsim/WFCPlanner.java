...
/**
 * WFCPlanner supports dynamic planning. In the future we will have global and
 * static algorithm here. The WorkflowSim starts from WFCPlanner. It picks up a
 * planning algorithm based on the configuration
 *
 * @author Arman Riazi
...
//        Log.printLine("Starting  " + Parameters.getVersion());
